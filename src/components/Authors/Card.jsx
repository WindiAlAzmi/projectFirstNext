  ...
  return (
    <div className="p-2 w-full">
      <div className=" w-full flex flex-col  justify-center ">
        <div className="w-full md:w-3/6 mx-auto flex flex-row justify-center p-2">
          <img
        ...
        <div className=" flex-col p-2 text-sm md:text-base">
          <div className="p-2 flex flex-row flex-wrap w-full">
            <div className="w-2/6">
      ...
      <div className="flex flex-col mt-10 flex-wrap">
        <div className="font-bold text-base text-black">
          <h3>{dataPost.length}  Postingan</h3>
        </div>
        <div className="flex-wrap  flex flex-col md:flex-row lg:flex-row w-full ">
          {dataPost.map((dt) => (
      ...
      <div className="flex flex-col gap-2 md:gap-0 md:flex-row w-full md:justify-between  ">
        {/* <ButtonBack /> */}
